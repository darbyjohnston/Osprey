...
#define IDD_OPTIONS_PIXEL_SAMPLES_LABEL 205
#define IDD_OPTIONS_PIXEL_SAMPLES_COMBOBOX 206
#define IDD_OPTIONS_AO_SAMPLES_LABEL    207
#define IDD_OPTIONS_AO_SAMPLES_COMBOBOX 208
#define IDD_OPTIONS_DENOISER_CHECKBOX   209
